...
func main() {
	...
	e := echo.New() //declared then assigned

	// Initialize required handlers
	log.Print("Initialize..")
	initialization(e)//function = go routine
...
func initialization(e *echo.Echo) {
	log.Print("Executing Initalization tasks")//useful for debugging
	e.POST("/registerUser", registerUser)//create cmd
